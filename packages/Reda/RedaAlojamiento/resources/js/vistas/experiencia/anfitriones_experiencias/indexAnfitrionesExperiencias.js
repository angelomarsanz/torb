// resources/js/reda/vistas/experiencia/anfitrion_experiencias/indexAnfitrionExperiencias.js

$(function() {
    // 1. Verificar si el div específico de esta vista existe en la página.
    const containerId = '#index_anfitrion_experiencias';
    if ($(containerId).length) {

        // --- Aquí va todo el código de la vista de Index Anfitrion Experiencias --- 

        console.log('Script para "Index Anfitrión Experiencias" cargado.');

        // 2. Crear el botón y el modal
        const modalId = 'modalIndexAnfitrionExperiencias';
              ...
              <div class="modal-dialog" role="document">
                <div class="modal-content">
                  <div class="modal-header">
                    <h5 class="modal-title" id="modalLabel">Agregar un Anfitrión de Experiencia</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                      <span aria-hidden="true">&times;</span>
                    </button>
                  </div>
                  <div class="modal-body">
                    Estás agregando un anfitrión de experiencia.
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="card">
              ...
              <div class="card-body">
                ...
                <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#${modalId}">
                  Agregar un Anfitrión de Experiencia
                </button>
              </div>
            </div>
        `;
