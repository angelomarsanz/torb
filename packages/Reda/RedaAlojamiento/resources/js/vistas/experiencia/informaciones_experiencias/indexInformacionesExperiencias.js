// resources/js/reda/vistas/experiencia/informacion_experiencia/indexInformacionExperiencias.js

$(function() {
    // 1. Verificar si el div específico de esta vista existe en la página.
    const containerId = '#index_informacion_experiencias';
    if ($(containerId).length) {

        // --- Aquí va todo el código de la vista de Index Informacion Experiencias ---

        console.log('Script para "Index Informacion Experiencias" cargado.');

        // 2. Crear el botón y el modal
        const modalId = 'modalIndexInformacionExperiencias';
              ...
              <div class="modal-dialog" role="document">
                <div class="modal-content">
                  <div class="modal-header">
                    <h5 class="modal-title" id="modalLabel">Agregar Información de la Experiencia</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                      <span aria-hidden="true">&times;</span>
                    </button>
                  </div>
                  <div class="modal-body">
                    Estás agregando la información de la experiencia.
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="card">
              ...
              <div class="card-body">
                ...
                <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#${modalId}">
                  Agregar Información de la Experiencia
                </button>
              </div>
            </div>
        `;
