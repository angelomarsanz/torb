            ...
            <div class="main-panel min-height mt-4">
                <div class="row justify-content-center">
                    ...
                    <div class="col-md-9 mt-4 mt-sm-0 pl-4 pr-4">
                        <h4 class="font-weight-700">{{ __('reda-alojamiento::messages.general.productos_y_servicios') }}</h4>
                        <form method="post" id="list_des" action="{{ route('reda.experiencias.pasos', [$result->id, $paso]) }}" accept-charset='UTF-8' enctype="multipart/form-data">
                            ...
                            <button type="button" 
                                ...
                                title="{{ __('reda-alojamiento::messages.general.agregar_una_nueva_actividad') }}">
