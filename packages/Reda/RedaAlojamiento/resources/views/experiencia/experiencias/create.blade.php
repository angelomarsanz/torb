    ...
    <div class="row m-0">
        ...
        <div class="col-md-10 min-height">
            <div class="main-panel m-4 list-background border rounded-3">
                <h3 class="text-center mt-5 text-24 font-weight-700">{{ __('reda-alojamiento::messages.php.publica_tu_negocio') }}</h3>
                <p class="text-center text-16 pl-4 pr-4">{{ __('reda-alojamiento::messages.php.comparte_la_informacion_de_tu_negocio_con_viajeros_de_todo_el_mundo') }}</p>               
                        ...
                        <div class="col-md-12">
                            <div class="float-right">
                                <button type="submit" class="btn vbtn-outline-success text-16 font-weight-700 pl-5 pr-5 pt-3 pb-3 mt-4 mb-4" id="btn_next"> 
                                    ...
                                    <span id="btn_next-text">{{ __('reda-alojamiento::messages.php.continuar') }}</span>
                                </button>
                            </div>
                        </div>
                    </div>
